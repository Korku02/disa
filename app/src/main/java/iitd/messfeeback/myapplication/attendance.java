...
public class attendance extends Fragment implements View.OnClickListener {
    ...
    //View Objects
    private Button buttonAttendanceScan;
    private TextView editTextUsername;
    public static Boolean giveAttendance;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Give Attendance");
        ...
        buttonAttendanceScan = (Button) getActivity().findViewById(R.id.buttonAttendanceScan);
        ...
        buttonAttendanceScan.setOnClickListener(this);
