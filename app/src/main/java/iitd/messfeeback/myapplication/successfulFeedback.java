...
public class successfulFeedback extends AppCompatActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        setContentView(R.layout.activity_successful_feedback);
...
//        Typeface mont_light =Typeface.createFromAsset(getAssets(), "font/Montserrat-Light.ttf");
        ...
        new Handler().postDelayed(new Runnable() {
            public void run() {
                ...
                startActivity(new Intent(successfulFeedback.this, userlogin.class));
                finish();
